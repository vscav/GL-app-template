...
namespace engine {
    ...
    protected:
        ...
        std::shared_ptr<Camera> m_camera;                 /*!< A unique pointer to the camera used by the application. */
    ...
    public:
        ...
        explicit GLApplication(Camera *camera, GLWindowManager *manager, std::string title, int width, int height,
                               bool fullScreen);
