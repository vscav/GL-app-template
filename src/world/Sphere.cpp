...
namespace world
{
    ...
    void Sphere::buildVAO()
    {
        ...
        m_vbo.setVertexAttrib(VERTEX_ATTR_POSITION, 3, GL_FLOAT, sizeof(utils::ShapeVertex), offsetof(utils::ShapeVertex, position));
        m_vbo.setVertexAttrib(VERTEX_ATTR_NORMAL, 3, GL_FLOAT, sizeof(utils::ShapeVertex), offsetof(utils::ShapeVertex, normal));
        m_vbo.setVertexAttrib(VERTEX_ATTR_TEXCOORD, 3, GL_FLOAT, sizeof(utils::ShapeVertex), offsetof(utils::ShapeVertex, texCoords));
    ...
    void Sphere::render(const Camera *camera, opengl::Shader &shader, float time)
    {
    ...
    void Sphere::build(GLfloat r, GLsizei discLat, GLsizei discLong)
    {
        ...
        iterator::Container<utils::ShapeVertex> data;
